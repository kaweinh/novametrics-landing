...
const Features = (props: Props) => {
  return (
    <div className=' bg-my-pink-very-light p-[5vw] flex flex-col justify-center items-center w-full h-fit font-mukta-mahee text-my-midnight-blue'>
        <div className=' grid grid-cols-1 lg:grid-cols-3 w-full gap-4'>
            <div className='flex flex-col justify-center items-center px-4'>
                <div className="lg:w-[10vw] items-center justify-center z-30">
                    <div className=" relative pb-[100%] flex items-center justify-center">
                        <div className="absolute top-0 w-full h-full items-center flex justify-center">
                            <div className="absolute z-30 w-full h-full mix-blend-lighten">
                                ...
                                >
                                    <source src="/animations/holistic-icon.mp4" type="video/mp4" />
                    ...
                    <div className=" relative pb-[100%] flex items-center justify-center">
                        <div className="absolute top-0 w-full h-full items-center flex justify-center">
                            <div className="absolute z-30 w-full h-full">
                                <div className="absolute w-full h-full bg-[url('/components/open-source-icon.png')] bg-center bg-contain object-contain bg-no-repeat z-30" ></div>
                            </div>
                        </div>
                    </div>                     
                </div>
            ...
            <div className='flex flex-col justify-center items-center px-4'>
                <div className="lg:w-[12vw] items-center justify-center z-30">
                    <div className=" relative pb-[100%] flex items-center justify-center">
                        <div className="absolute top-0 w-full h-full items-center flex justify-center">
                            <div className="absolute z-30 w-full h-full mix-blend-lighten">
                                <video
                                    ...
                                    className="w-full h-full object-cover"
                                >
                                    <source src="/animations/corners-dots.mp4" type="video/mp4" />
                                    Your browser does not support the video tag.
                                </video>
                            </div>
                        </div>
